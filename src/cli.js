...
program.command('keypair')
    ...
    .alias('key')
    .option('-H, --has [text]', 'generated public key will include the specified text')
    .action(function(options) {
        ...
        writeLine('')
        writeLine('Tip:')
        writeLine('  You can save your keys to a file with the \'>\' operator')
        writeLine('')
        writeLine('Examples:')
        writeLine('  $ keypair --has 2pac')
        writeLine('  $ keypair > secret.json')
    })
